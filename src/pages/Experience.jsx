...
function Experience() {
  return (
    <section className="px-6 py-12 max-w-5xl mx-auto">
      ...
      <div className="mb-12">
        <h2 className="flex items-center gap-2 text-2xl font-bold text-blue-400 mb-6 border-b border-gray-700 pb-2">
          <BadgeCheck className="w-6 h-6 text-blue-500" /> Certifications
        </h2>
      ...
      <div className="mb-12">
        <h2 className="flex items-center gap-2 text-2xl font-bold text-blue-400 mb-6 border-b border-gray-700 pb-2">
          <BookOpen className="w-6 h-6 text-blue-500" /> Training
        </h2>
        <ul className="space-y-3">
      ...
      <div>
        <h2 className="flex items-center gap-2 text-2xl font-bold text-blue-400 mb-6 border-b border-gray-700 pb-2">
          <AwardIcon className="w-6 h-6 text-blue-500" /> Awards
        </h2>
        <ul className="space-y-3">
          {awards.map((award, i) => (
            <motion.li
