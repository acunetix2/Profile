        ...
        {(open || window.innerWidth >= 768) && (
          <motion.aside
            ...
            className={cn(
              ...
              "border-r border-gray-800 shadow-xl flex flex-col justify-between z-40 pt-12 md:pt-0"
            )}
          >
            {/* Branding */}
            <div className="hidden md:flex flex-col items-center p-6 border-b border-gray-800">
